(function () {
  ...
  function renderEcHome(options = {}) {
    ...
    document.querySelector("#app").innerHTML = `<main class="experience-home" aria-label="Health Check"><nav class="experience-fixed-nav" aria-label="主要メニュー"><a class="nav-primary" href="/body-check" data-start-diagnosis>原因筋を探す</a><a href="/health-library" data-link>記事</a></nav><section class="experience-world"><div class="bio-field" aria-hidden="true"><span class="cell c1"></span><span class="cell c2"></span><span class="cell c3"></span><span class="fiber f1"></span><span class="fiber f2"></span><span class="fiber f3"></span><span class="nerve n1"></span><span class="nerve n2"></span></div><div class="experience-terms" aria-label="健康情報の入口">${renderAmbientTerms()}</div><div class="experience-copy"><p class="experience-label">HEALTH CHECK</p><h1>その痛み、<br />どこから来ている？</h1><p class="experience-lead">痛みの手がかりを、身体の中から探す。症状や動きを選ぶだけで、関係している可能性がある筋肉と、読みたい健康記事へ進めます。</p><div class="experience-actions"><a class="experience-start" href="/body-check" data-start-diagnosis aria-label="原因筋チェックを開始する"><span>START</span><strong>原因筋チェック</strong></a><a class="experience-journal-link" href="/health-library" data-link>記事から探す</a></div><p class="experience-note">※医療診断ではありません。強い痛み・しびれ・麻痺・発熱などがある場合は医療機関へ相談してください。</p></div></section><section class="experience-mini-cards" aria-label="Health Checkの使い方"><article><span>01</span><h2>症状を選ぶ</h2><p>部位、動き、症状の感じ方を一問ずつ整理します。</p></article><article><span>02</span><h2>候補筋肉を見る</h2><p>原因の断定ではなく、関係している可能性を示します。</p></article><article><span>03</span><h2>記事で深める</h2><p>結果に近い健康記事を読み、体の理解につなげます。</p></article></section><section class="experience-quiet-links"><div><p class="eyebrow">Health Journal</p><h2>身体を、もう少し深く知る。</h2><p>記事をじっくり読みたい方は、健康情報ライブラリへ。</p></div><a class="secondary-button" href="/health-library" data-link>健康記事を見る</a></section><section class="caution-card experience-caution"><h2>注意文</h2><p>${CAUTION_TEXT}</p><a class="text-link" href="/faq" data-link>よくある質問を見る</a></section><div class="experience-transition" aria-hidden="true"><span></span><span></span><span></span></div></main>`;
    bindExperienceStart();
    bindSearchForms();
